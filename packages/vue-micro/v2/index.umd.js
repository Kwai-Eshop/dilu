(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue-demi"), require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue-demi", "vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.DLVueMicro = {}, global.vueDemi, global.Vue));
  ...
  vueDemi.defineComponent({
    render(h) {
      var _a;
      return h("div", [(_a = this == null ? void 0 : this.$slots) == null ? void 0 : _a.default, " "]);
    }
  });
  const MicroAppContainer = vueDemi.defineComponent({
    props: ["extra"],
    data() {
      return {
  ...
  exports2.isDLRunEnvironment = isMicro;
  exports2.mount = mount;
  exports2.registerDLMicro = registerDLMicro;
