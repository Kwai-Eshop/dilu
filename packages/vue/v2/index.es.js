import { onBeforeMount, onUnmounted, defineComponent, h as h$1, ref, onMounted, getCurrentInstance, watch, computed, onBeforeUnmount, reactive } from "vue-demi";
if (!window.fetch) {
...
const RouteAppContainer = defineComponent({
...
const BootstrapComponent = defineComponent({
  ...
  setup(props2, {
    ...
    return () => {
      var _a;
      return h$1("div", [h$1(RouteAppContainer, {
        "attrs": {
          ...{
            containerIdentity: props2.isOccupyOuterContainer ? "" : props2.containerId
          }
        }
      }), !!registrableMicros.value.length && !hasActivedMicroApp.value ? h$1(Teleport, {
        "attrs": {
          ...{
...
const DLSwitch = defineComponent({
  props: ["extra", "advanced", "collect", "loader", "defaultMountAppLink", "isOccupyOuterContainer", "containerId", "activeFilter", "onFirstMount", "onBeforeLoad", "onBeforeMount", "onAfterMount", "onBeforeUnmount", "onAfterUnmount", "onError", "microList"],
  inheritAttrs: false,
  setup(props2, {
    slots
...
const DLRouter = defineComponent({
  name: "DLRouter",
  components: {
    DLSwitch,
    DLRoute
  ...
  setup(props2, {
    ...
    onBeforeMount(async () => {
      ...
      try {
        ...
        collect(CollectType.ERROR, e2);
        debug$1("获取到子应用列表失败: %O", e2);
        fetchStatus.value = FetchStatus.Error;
      }
    });
    return () => fetchStatus.value == FetchStatus.Fetched ? h$1(DLSwitch, {
      "attrs": {
        ...{
          ...restProps,
          collect,
...
const DLWidget = defineComponent({
