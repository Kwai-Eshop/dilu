(function(global2, factory) {
  ...
  const DLRouter = vueDemi.defineComponent({
    ...
    setup(props2, {
      ...
      const fetchStatus = vueDemi.ref(exports2.FetchStatus.Init);
      ...
      vueDemi.onBeforeMount(async () => {
        ...
        try {
          ...
          microList.value = (_b = micros == null ? void 0 : micros.filter) == null ? void 0 : _b.call(micros, (micro) => {
            return micro.type === exports2.MicroType.Route;
          });
          fetchStatus.value = exports2.FetchStatus.Fetched;
        } catch (e2) {
          collect(exports2.CollectType.ERROR, e2);
          debug$1("获取到子应用列表失败: %O", e2);
          fetchStatus.value = exports2.FetchStatus.Error;
        }
      });
      return () => fetchStatus.value == exports2.FetchStatus.Fetched ? vueDemi.h(DLSwitch, {
        "attrs": {
          ...{
            ...restProps,
            collect,
