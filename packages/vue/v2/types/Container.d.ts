...
export declare const RouteAppContainer: import("vue").ComponentOptions<import("vue").default, import("@vue/composition-api").ShallowUnwrapRef<() => JSX.Element> & import("@vue/composition-api").Data, {}, {}, string[], import("@vue/composition-api").ExtractPropTypes<string[]>> & Omit<import("vue").VueConstructor<import("vue").default>, never> & (new (...args: any[]) => import("@vue/composition-api").ComponentRenderProxy<{
    [x: number]: string;
} & {
