...
const DLRouter = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(props2, {
    ...
    const fetchStatus = vue.ref(exports.FetchStatus.Init);
    ...
    vue.onBeforeMount(async () => {
      ...
      try {
        ...
        ((collect == null ? void 0 : collect.value) || defaultCollect$1)(exports.CollectType.ERROR, e2);
        debug$1("获取到子应用列表失败: %O", e2);
        fetchStatus.value = exports.FetchStatus.Error;
      }
    });
    return () => fetchStatus.value == exports.FetchStatus.Fetched ? vue.createVNode(DLSwitch, vue.mergeProps(props2, {
      ...
      default: () => {
        ...
        let routes = (_b = (_a = microList.value) == null ? void 0 : _a.map) == null ? void 0 : _b.call(_a, (micro) => {
          if (micro.type === exports.MicroType.Route) {
