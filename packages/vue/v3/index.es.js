...
(function(FetchStatus2) {
  ...
  FetchStatus2[FetchStatus2["Fetching"] = 1] = "Fetching";
...
var MicroType;
(function(MicroType2) {
  MicroType2["Route"] = "route";
  MicroType2["Component"] = "component";
})(MicroType || (MicroType = {}));
...
var WidgetAppMethods;
(function(WidgetAppMethods2) {
  WidgetAppMethods2["mount"] = "mount";
  WidgetAppMethods2["unmount"] = "unmount";
  WidgetAppMethods2["getStatus"] = "getStatus";
  WidgetAppMethods2["loadPromise"] = "loadPromise";
  WidgetAppMethods2["bootstrapPromise"] = "bootstrapPromise";
  WidgetAppMethods2["mountPromise"] = "mountPromise";
  WidgetAppMethods2["unmountPromise"] = "unmountPromise";
  WidgetAppMethods2["update"] = "update";
})(WidgetAppMethods || (WidgetAppMethods = {}));
...
var CollectType;
(function(CollectType2) {
  CollectType2["ERROR"] = "ERROR";
  CollectType2["MicroError"] = "MicroError";
  CollectType2["GlobalUncaughtError"] = "GlobalUncaughtError";
  CollectType2["Duration"] = "Duration";
  ...
  ["beforeLoad", "beforeMount", "afterMount", "beforeUnmount", "afterUnmount"].forEach((lc) => {
    lifeCycle[lc] = async (app) => {
      ...
      try {
        ...
        collect == null ? void 0 : collect(CollectType.ERROR, e2);
      }
      if (lc == "afterMount") {
        try {
          const duration = {
          ...
          collect == null ? void 0 : collect(CollectType.Duration, {
            ...app,
            duration
          });
...
function patchAtMounting(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter, speedySandBox) {
  ...
  var patchersInSandbox = (_patchersInSandbox = {}, _defineProperty$1(_patchersInSandbox, SandBoxType.LegacyProxy, [].concat(basePatchers, [function() {
    return patchLooseSandbox(appName, elementGetter, sandbox, true, scopedCSS, excludeAssetFilter);
  }])), _defineProperty$1(_patchersInSandbox, SandBoxType.Proxy, [].concat(basePatchers, [function() {
    return patchStrictSandbox(appName, elementGetter, sandbox, true, scopedCSS, excludeAssetFilter, speedySandBox);
  }])), _defineProperty$1(_patchersInSandbox, SandBoxType.Snapshot, [].concat(basePatchers, [function() {
    return patchLooseSandbox(appName, elementGetter, sandbox, true, scopedCSS, excludeAssetFilter);
  }])), _patchersInSandbox);
...
function patchAtBootstrapping(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter, speedySandBox) {
  ...
  var patchersInSandbox = (_patchersInSandbox2 = {}, _defineProperty$1(_patchersInSandbox2, SandBoxType.LegacyProxy, [function() {
    return patchLooseSandbox(appName, elementGetter, sandbox, false, scopedCSS, excludeAssetFilter);
  }]), _defineProperty$1(_patchersInSandbox2, SandBoxType.Proxy, [function() {
    return patchStrictSandbox(appName, elementGetter, sandbox, false, scopedCSS, excludeAssetFilter, speedySandBox);
  }]), _defineProperty$1(_patchersInSandbox2, SandBoxType.Snapshot, [function() {
    return patchLooseSandbox(appName, elementGetter, sandbox, false, scopedCSS, excludeAssetFilter);
  }]), _patchersInSandbox2);
...
const useCollectError = (collect, onError) => {
  const errorHandler = (error) => {
    collect == null ? void 0 : collect(CollectType.MicroError, error);
  ...
  const globalUncaughtErrorHandler = (error) => {
    collect == null ? void 0 : collect(CollectType.GlobalUncaughtError, {
      ...error
    });
...
const RouteAppContainer = /* @__PURE__ */ defineComponent({
  ...
  setup(props2, {
    ...
    return () => {
      var _a;
      return createVNode("div", mergeProps(identity2, {
        "ref": divDOM
...
const Teleport = /* @__PURE__ */ defineComponent({
  props,
  setup(props2, {
    slots
  }) {
...
const BootstrapComponent = /* @__PURE__ */ defineComponent({
  ...
  setup(props2, {
    ...
    const registrableMicros = ref([]);
    const downgradMicros = ref([]);
    ...
    watch(() => props2.extra, (value) => {
      microAppStateActions.setGlobalState(value || {});
    });
    return () => {
      return createVNode("div", null, [createVNode(RouteAppContainer, {
        "containerIdentity": props2.isOccupyOuterContainer ? "" : props2.containerId
      }, null), !!registrableMicros.value.length && !hasActivedMicroApp.value ? createVNode(Teleport, {
...
const DLSwitch = /* @__PURE__ */ defineComponent({
  props: ["extra", "advanced", "collect", "loader", "defaultMountAppLink", "isOccupyOuterContainer", "containerId", "activeFilter", "onFirstMount", "onBeforeLoad", "onBeforeMount", "onAfterMount", "onBeforeUnmount", "onAfterUnmount", "onError"],
  inheritAttrs: false,
  setup(props2, {
    slots
    ...
    return () => createVNode(BootstrapComponent, mergeProps(props2, {
...
const DLRoute = /* @__PURE__ */ defineComponent({
...
const DLRouter = /* @__PURE__ */ defineComponent({
  name: "DLRouter",
  components: {
    DLSwitch,
    DLRoute
  ...
  setup(props2, {
    ...
    onBeforeMount(async () => {
      ...
      try {
        ...
        ((collect == null ? void 0 : collect.value) || defaultCollect$1)(CollectType.ERROR, e2);
        debug$1("获取到子应用列表失败: %O", e2);
        fetchStatus.value = FetchStatus.Error;
      }
    });
    return () => fetchStatus.value == FetchStatus.Fetched ? createVNode(DLSwitch, mergeProps(props2, {
      ...
      default: () => {
        ...
        let routes = (_b = (_a = microList.value) == null ? void 0 : _a.map) == null ? void 0 : _b.call(_a, (micro) => {
          if (micro.type === MicroType.Route) {
            return createVNode(DLRoute, mergeProps(micro, {
              "key": micro.name
            }), null);
          }
          return null;
        ...
        if (slots.default) {
          routes.push(createVNode(DLRoute, null, {
            default: (slotProps) => {
              var _a2;
...
const DLWidget = /* @__PURE__ */ defineComponent({
  ...
  setup(props2, {
    ...
    const init = () => {
      ...
      ["loadPromise", "bootstrapPromise", "mountPromise"].forEach((key) => {
        ...
        promise == null ? void 0 : promise.catch((e2) => {
          ...
          collect == null ? void 0 : collect(CollectType.MicroError, e2);
          loader == null ? void 0 : loader(false);
        });
      });
    ...
    watch(() => props2 == null ? void 0 : props2.name, () => {
      init();
    }, {
      deep: true,
      flush: "post"
