(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.DLVue = {}, global2.Vue));
  ...
  exports2.MicroType = void 0;
  (function(MicroType) {
    MicroType["Route"] = "route";
    MicroType["Component"] = "component";
  })(exports2.MicroType || (exports2.MicroType = {}));
  ...
  exports2.WidgetAppMethods = void 0;
  ...
  })(exports2.CollectType || (exports2.CollectType = {}));
    ...
    ["beforeLoad", "beforeMount", "afterMount", "beforeUnmount", "afterUnmount"].forEach((lc) => {
      lifeCycle[lc] = async (app) => {
        ...
        try {
          ...
          collect == null ? void 0 : collect(exports2.CollectType.ERROR, e2);
        }
        if (lc == "afterMount") {
          try {
            const duration = {
            ...
            collect == null ? void 0 : collect(exports2.CollectType.Duration, {
              ...app,
              duration
            });
  ...
  (function(module2) {
    ...
    function _regeneratorRuntime() {
      ...
      return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty2(Gp, "constructor", {
        ...
        return exports3.isGeneratorFunction(outerFn) ? iter2 : iter2.next().then(function(result) {
  ...
  var requestIdleCallback$1 = window.requestIdleCallback || function requestIdleCallback2(cb) {
    var start2 = Date.now();
      ...
      function exec(scriptSrc, inlineScript, resolve) {
        ...
        if (scriptSrc === entry) {
          ...
          try {
            ...
            var exports3 = proxy[getGlobalProp(strictGlobal ? proxy : window)] || {};
            resolve(exports3);
          } catch (e2) {
  ...
  function validateExportLifecycle(exports3) {
    var _ref = exports3 !== null && exports3 !== void 0 ? exports3 : {}, bootstrap = _ref.bootstrap, mount = _ref.mount, unmount = _ref.unmount;
  ...
  var LegacySandbox = /* @__PURE__ */ function() {
    function LegacySandbox2(name2) {
      ...
      this.type = exports2.SandBoxType.LegacyProxy;
  ...
  var ScopedCSS = /* @__PURE__ */ function() {
    ...
    _createClass(ScopedCSS2, [{
      key: "process",
      value: function process2(styleNode) {
        var _this = this;
  ...
  var ProxySandbox = /* @__PURE__ */ function() {
    function ProxySandbox2(name2) {
      ...
      this.name = name2;
      this.globalContext = globalContext;
      this.type = exports2.SandBoxType.Proxy;
  ...
  function patchAtMounting(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter, speedySandBox) {
    ...
    var patchersInSandbox = (_patchersInSandbox = {}, _defineProperty$1(_patchersInSandbox, exports2.SandBoxType.LegacyProxy, [].concat(basePatchers, [function() {
      return patchLooseSandbox(appName, elementGetter, sandbox, true, scopedCSS, excludeAssetFilter);
    }])), _defineProperty$1(_patchersInSandbox, exports2.SandBoxType.Proxy, [].concat(basePatchers, [function() {
      return patchStrictSandbox(appName, elementGetter, sandbox, true, scopedCSS, excludeAssetFilter, speedySandBox);
    }])), _defineProperty$1(_patchersInSandbox, exports2.SandBoxType.Snapshot, [].concat(basePatchers, [function() {
      return patchLooseSandbox(appName, elementGetter, sandbox, true, scopedCSS, excludeAssetFilter);
    }])), _patchersInSandbox);
  ...
  function patchAtBootstrapping(appName, elementGetter, sandbox, scopedCSS, excludeAssetFilter, speedySandBox) {
    ...
    var patchersInSandbox = (_patchersInSandbox2 = {}, _defineProperty$1(_patchersInSandbox2, exports2.SandBoxType.LegacyProxy, [function() {
      return patchLooseSandbox(appName, elementGetter, sandbox, false, scopedCSS, excludeAssetFilter);
    }]), _defineProperty$1(_patchersInSandbox2, exports2.SandBoxType.Proxy, [function() {
      return patchStrictSandbox(appName, elementGetter, sandbox, false, scopedCSS, excludeAssetFilter, speedySandBox);
    }]), _defineProperty$1(_patchersInSandbox2, exports2.SandBoxType.Snapshot, [function() {
      return patchLooseSandbox(appName, elementGetter, sandbox, false, scopedCSS, excludeAssetFilter);
    }]), _patchersInSandbox2);
  ...
  var SnapshotSandbox = /* @__PURE__ */ function() {
    function SnapshotSandbox2(name2) {
      ...
      this.name = name2;
      this.proxy = window;
      this.type = exports2.SandBoxType.Snapshot;
    }
  ...
  function prefetch(entry, opts) {
    ...
    requestIdleCallback(/* @__PURE__ */ _asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee() {
  ...
  const useCollectError = (collect, onError) => {
    const errorHandler = (error) => {
      collect == null ? void 0 : collect(exports2.CollectType.MicroError, error);
    ...
    const globalUncaughtErrorHandler = (error) => {
      collect == null ? void 0 : collect(exports2.CollectType.GlobalUncaughtError, {
        ...error
      });
  ...
  const RouteAppContainer = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(props2, {
      ...
      return () => {
        var _a;
        return vue.createVNode("div", vue.mergeProps(identity2, {
          "ref": divDOM
  ...
  const Teleport = /* @__PURE__ */ vue.defineComponent({
    props,
    setup(props2, {
      slots
    }) {
      ...
      vue.onMounted(() => {
        ...
        if (container) {
          (_a = container == null ? void 0 : container.appendChild) == null ? void 0 : _a.call(container, el == null ? void 0 : el.value);
        }
        try {
          if (container && ((_b = container == null ? void 0 : container.dataset) == null ? void 0 : _b.dlDowngradContainer)) {
            microContainer = document.getElementById((_c = container == null ? void 0 : container.dataset) == null ? void 0 : _c.dlDowngradContainer);
            if (microContainer) {
  ...
  const BootstrapComponent = /* @__PURE__ */ vue.defineComponent({
    props: ["extra", "advanced", "collect", "loader", "defaultMountAppLink", "isOccupyOuterContainer", "containerId", "activeFilter", "onFirstMount", "onBeforeLoad", "onBeforeMount", "onAfterMount", "onBeforeUnmount", "onAfterUnmount", "onError"],
    setup(props2, {
      slots
    }) {
      const registrableMicros = vue.ref([]);
      const downgradMicros = vue.ref([]);
      const hasActivedMicroApp = vue.ref(true);
      ...
      const init = () => {
        ...
        let micros = [];
        let notFoundMicros = [];
        (_a = slots == null ? void 0 : slots.default) == null ? void 0 : _a.call(slots).forEach((vNode) => {
          var _a2, _b;
          if (((_a2 = vNode == null ? void 0 : vNode.type) == null ? void 0 : _a2.name) === "DLRoute") {
            const vNodeProps = vNode.props;
            if ((vNodeProps == null ? void 0 : vNodeProps.name) && (vNodeProps == null ? void 0 : vNodeProps.entry) && (vNodeProps == null ? void 0 : vNodeProps.activeRule)) {
              const micro = {
                ...
                props: {
                  ...
                  ...vNodeProps == null ? void 0 : vNodeProps.extras,
                  ...vNodeProps == null ? void 0 : vNodeProps.extra
                }
              };
              micros.push(micro);
            } else if ((_b = vNode == null ? void 0 : vNode.children) == null ? void 0 : _b.default) {
              notFoundMicros.push((slotProps) => {
                var _a3;
                return (_a3 = vNode == null ? void 0 : vNode.children) == null ? void 0 : _a3.default(slotProps);
              });
            }
          } else {
            debug$3("DLSwitch组件的Slots只能使用DLRoute：%O", vNode);
          }
        });
      ...
      vue.watch(() => props2.extra, (value) => {
        microAppStateActions.setGlobalState(value || {});
      });
      return () => {
        return vue.createVNode("div", null, [vue.createVNode(RouteAppContainer, {
          "containerIdentity": props2.isOccupyOuterContainer ? "" : props2.containerId
        }, null), !!registrableMicros.value.length && !hasActivedMicroApp.value ? vue.createVNode(Teleport, {
          "to": findDowngradContainer(props2.containerId)
        }, {
          default: () => {
            var _a;
            return [(_a = downgradMicros == null ? void 0 : downgradMicros.value) == null ? void 0 : _a.map((slot) => {
              var _a2;
              const state = {
  ...
  const DLSwitch = /* @__PURE__ */ vue.defineComponent({
    props: ["extra", "advanced", "collect", "loader", "defaultMountAppLink", "isOccupyOuterContainer", "containerId", "activeFilter", "onFirstMount", "onBeforeLoad", "onBeforeMount", "onAfterMount", "onBeforeUnmount", "onAfterUnmount", "onError"],
    inheritAttrs: false,
    setup(props2, {
      slots
    }) {
      const isUseOuterContainer = vue.computed(() => {
        let flag = false;
      ...
      const wrapperId = vue.computed(() => {
        if (props2.containerId) {
          return props2.containerId;
        }
        return containerRandomId;
      });
      return () => vue.createVNode(BootstrapComponent, vue.mergeProps(props2, {
        "containerId": wrapperId.value,
        "isOccupyOuterContainer": isUseOuterContainer.value
      }), {
        default: (slotProps) => {
          var _a;
          return (_a = slots == null ? void 0 : slots.default) == null ? void 0 : _a.call(slots, slotProps);
        }
      });
    }
  });
  const DLRoute = /* @__PURE__ */ vue.defineComponent({
  ...
  const DLRouter = /* @__PURE__ */ vue.defineComponent({
    name: "DLRouter",
    components: {
      DLSwitch,
      DLRoute
    ...
    setup(props2, {
      ...
      const fetchStatus = vue.ref(exports2.FetchStatus.Init);
      const microList = vue.ref([]);
      const {
        collect,
        fetchMicros,
        ...restProps
      ...
      vue.onBeforeMount(async () => {
        var _a;
        fetchStatus.value = exports2.FetchStatus.Fetching;
        try {
          ...
          fetchStatus.value = exports2.FetchStatus.Fetched;
        } catch (e2) {
          ((collect == null ? void 0 : collect.value) || defaultCollect$1)(exports2.CollectType.ERROR, e2);
          debug$1("获取到子应用列表失败: %O", e2);
          fetchStatus.value = exports2.FetchStatus.Error;
        }
      });
      return () => fetchStatus.value == exports2.FetchStatus.Fetched ? vue.createVNode(DLSwitch, vue.mergeProps(props2, {
        "collect": (collect == null ? void 0 : collect.value) || defaultCollect$1
      }), {
        default: () => {
          var _a, _b;
          let routes = (_b = (_a = microList.value) == null ? void 0 : _a.map) == null ? void 0 : _b.call(_a, (micro) => {
            if (micro.type === exports2.MicroType.Route) {
              return vue.createVNode(DLRoute, vue.mergeProps(micro, {
                "key": micro.name
              }), null);
            }
            return null;
          ...
          if (slots.default) {
            routes.push(vue.createVNode(DLRoute, null, {
              default: (slotProps) => {
                var _a2;
  ...
  const DLWidget = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(props2, {
      ...
      const microAppRef = vue.reactive({
        instance: null
      });
      const init = () => {
        ...
        const instance = loadMicroApp({
          name: props2.name,
          entry: props2.entry,
          container: container == null ? void 0 : container.value,
          props: {
            ...props2.extra,
            isDLWidget: true
          }
          ...
          beforeLoad: (app) => {
            ...
            return Promise.resolve((_a = props2 == null ? void 0 : props2.onBeforeLoad) == null ? void 0 : _a.call(props2, app));
          },
          beforeMount: (app) => {
            var _a;
            debug("【%s】子应用完成加载-beforeMount", props2.name);
            return Promise.resolve((_a = props2 == null ? void 0 : props2.onBeforeMount) == null ? void 0 : _a.call(props2, app));
          },
          afterMount: (app) => {
            var _a;
            debug("【%s】子应用完成DOM挂载-afterMount", props2.name);
            return Promise.resolve((_a = props2 == null ? void 0 : props2.onAfterMount) == null ? void 0 : _a.call(props2, app));
          },
          beforeUnmount: (app) => {
            var _a;
            debug("【%s】子应用开始DOM卸载-beforeUnmount", props2.name);
            return Promise.resolve((_a = props2 == null ? void 0 : props2.onBeforeUnmount) == null ? void 0 : _a.call(props2, app));
          },
          afterUnmount: (app) => {
            var _a;
            debug("【%s】子应用完成DOM卸载-afterUnmount", props2.name);
            return Promise.resolve((_a = props2 == null ? void 0 : props2.onAfterUnmount) == null ? void 0 : _a.call(props2, app));
          }
        });
        ...
        ["loadPromise", "bootstrapPromise", "mountPromise"].forEach((key) => {
          ...
          promise == null ? void 0 : promise.catch((e2) => {
            ...
            collect == null ? void 0 : collect(exports2.CollectType.MicroError, e2);
            loader == null ? void 0 : loader(false);
          });
        });
      ...
      vue.watch(() => props2 == null ? void 0 : props2.name, () => {
        init();
      }, {
        deep: true,
        flush: "post"
  ...
  exports2.DLRoute = DLRoute;
  exports2.DLRouter = DLRouter;
  exports2.DLSwitch = DLSwitch;
  exports2.DLWidget = DLWidget;
  exports2.__internalGetCurrentRunningApp = getCurrentRunningApp;
  exports2.addErrorHandler = a;
  exports2.addGlobalUncaughtErrorHandler = addGlobalUncaughtErrorHandler;
  exports2.containerIsExists = containerIsExists;
  exports2.containerRandomId = containerRandomId;
  ...
  exports2.pathToActiveWhen = pathToActiveWhen;
  exports2.polyfillCustomEvent = polyfillCustomEvent;
  exports2.prefetchApps = prefetchImmediately;
  exports2.registerMicroApps = registerMicroApps;
  exports2.removeErrorHandler = c;
  exports2.removeGlobalUncaughtErrorHandler = removeGlobalUncaughtErrorHandler;
  exports2.runAfterFirstMounted = runAfterFirstMounted;
  exports2.runDefaultMountEffects = runDefaultMountEffects;
  exports2.sanitizeActiveWhen = sanitizeActiveWhen;
  exports2.setDefaultMountApp = setDefaultMountApp;
